  ...
  return (
      <div className='w-full h-[70px] flex items-center justify-evenly px-20 py-2 border-b-2 border-gray-300 dark:border-gray-500'>
        ...
        <div>
          ...
          <span className={`border  w-24 mb-6 ${address === 2 ? "border-purple-400" : " border-gray-300 dark:border-gray-400"} `}></span>
          ...
          <span className={`border  w-24 mb-6 -ml-3 ${address === 3 ? "border-purple-400" : " border-gray-300 dark:border-gray-400"} `}></span>
          ...
          <span className={`border  w-24 mb-6 -ml-3 ${address === 4 ? "border-purple-400" : " border-gray-300 dark:border-gray-400"} `}></span>
