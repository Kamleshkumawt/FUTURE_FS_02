...
const AddCategory = () => {
  ...
  return (
    <>
      ...
      {/* Search Bar */}
      <div className="w-full border border-gray-400 rounded-sm flex items-center gap-2 shadow-sm shadow-gray-300 p-[10px] bg-white dark:bg-[#1c1416] mt-3">
        {/* Left Icon */}
        <svg
          width="20"
          height="20"
      ...
      <div className="w-full flex flex-col sm:flex-row  gap-5  mt-4">
          ...
          <div className="w-full flex flex-col sm:flex-row gap-5 overflow-x-auto">
            {Object.entries(categoryTree)
              ...
              .map(([level, categories]) => (
                <div
                  key={level}
                  className="w-full flex flex-col bg-white dark:bg-[#1d1416] rounded-sm min-w-[200px]"
                >
                  <h1
                    className={`text-lg font-medium text-center border-b border-gray-300 dark:border-gray-600 py-3 ${
                  ...
                  {categories.map((category) => (
                    <div
                      ...
                      className={`flex items-center p-2 cursor-pointer border-b border-gray-300 dark:border-gray-600 ${
        ...
        {Object.keys(selectedPath).length > 0 && (
          <div className="max-w-xl bg-white dark:bg-[#1b1314] rounded-sm flex flex-col items-center gap-5 transition-all duration-300 animate-fadeIn">
            <div className="bg-gray-200 dark:bg-[#23171b] w-full text-center p-2 max-w-sm">
              {getSelectedCategoryPath().join(" / ")}
            </div>
        ...
        {Object.keys(selectedPath).length === 0 && (
          <div className="max-w-xl bg-white dark:bg-[#060404] rounded-sm flex flex-col items-center gap-5 transition-all duration-300 animate-fadeIn">
            <div className="bg-gray-200 dark:bg-[#1a1416]  w-full text-center p-2 max-w-sm">
              {getSelectedCategoryPath().join(" / ")}
            </div>
